...
courses |>
  ...
  knitr::kable()
```
I just did this because the merge dataset (avg_by_group) I just created was empty and I didn't understant why until I realised that maybe I was not naming in the proper way the courses, so I did it to know the accurate names.
